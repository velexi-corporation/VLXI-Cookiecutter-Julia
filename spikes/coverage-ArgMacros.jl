...
function main()
    ...
    @inlinearguments begin
        @helpusage "coverage.jl [-k] [-d PKG-DIR] [-v]"

        @helpdescription "Generate code coverage analysis."

        @argumentflag keep_cov_files "-k" "--keep-cov-files"
        @arghelp "retain *.cov files"

        @argumentdefault String "." pkg_dir "-d" "--pkg-dir"
        @arghelp "package directory"

        @argumentflag verbose "-v" "--verbose"
        @arghelp "enable verbose mode"
    end
